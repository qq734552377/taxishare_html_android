...
import com.ucast.taxisharing.activity.RegistSecondActivity;
...
//        Log.e(TAG, "getImage: 采样压缩后的大小："+bitmap.getByteCount()/1024+"   压缩比："+be );
    ...
    private static String saveMyBitmap(String filename, Bitmap bit) {
        String baseDir = RegistSecondActivity.SAVED_IMAGE_DIR_PATH;
     ...
     * @return
     */
    public static String compressImageUpload(String filename,String path) {
